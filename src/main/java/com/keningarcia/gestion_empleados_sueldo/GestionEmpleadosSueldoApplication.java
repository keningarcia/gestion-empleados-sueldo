...
@SpringBootApplication(scanBasePackages = {"com.keningarcia.gestion_empleados_sueldo", "entity", "service", "repository", "dto", "controller", "exception", "mapper", "security", "config"})
